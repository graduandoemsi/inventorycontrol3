...
/**
 * Description of EntradaProdutoDAO
 *
 * 
 */
class EntradaProdutoDAO implements Crud {
    ...
    public function get($id) {
         try {
        $conexao = ConexaoBanco::getInstance()->getConnection();
        $sql = "select * from entrada_produto where id=:id";
        $prepare = $conexao->prepare($sql);
        $prepare->bindValue(":id",$id);
        $prepare->execute();
    ...
    public function insert($obj) {
        try {
        $conexao = ConexaoBanco::getInstance()->getConnection();
        $sql = "insert into entrada_produto (id_produto,quantidade,data) values (:id_produto,:quantidade,:data)";
        $prepare = $conexao->prepare($sql);
